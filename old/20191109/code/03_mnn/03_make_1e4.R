...
saveRDS(d,file='/scratch/users/whou10@jhu.edu/Wenpin/GBM/res/mnn/mnn_1e4.rds')
saveRDS(dim,file='/scratch/users/whou10@jhu.edu/Wenpin/GBM/res/mnn/dim_1e4.rds')
