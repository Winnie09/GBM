...
for (act in c('Lymph', 'M', 'Tumor')) {
  ...
  str(res)
  reslist[[act]] = res
  ## only use samples with treatment "untreated" and "NA" 
  ...
  pdf(paste0('/home-4/whou10@jhu.edu/scratch/Wenpin/GBM/qcplot/plot/',act,'_cellnum2.pdf'), width = 5, height = 7)
...
saveRDS(reslist, '/home-4/whou10@jhu.edu/scratch/Wenpin/GBM/qcplot/pd/all_stat.rds')
