...
library(ggplot2)
library(gridExtra)
dir.create(paste0('/home-4/whou10@jhu.edu/scratch/Wenpin/GBM/scranEachSampleWithAtlas/plot/umap_cluster'),showWarnings = F,recursive = T)
pdf(paste0('/home-4/whou10@jhu.edu/scratch/Wenpin/GBM/scranEachSampleWithAtlas/plot/umap_cluster/',sp,'.pdf'),width=8,height=7.5)
