...
saveRDS(d,file='/home-4/whou10@jhu.edu/scratch/Wenpin/GBM/database/res/mnn/mnn.rds')
saveRDS(dim,file='/home-4/whou10@jhu.edu/scratch/Wenpin/GBM/database/res/mnn/dim.rds')
