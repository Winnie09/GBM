...
print('20')
dir.create('/home-4/whou10@jhu.edu/scratch/Wenpin/GBM/integrate_GBM_to_atlas_referenceLi/res/seurat/',showWarnings = F, recursive = T)
saveRDS(d.integrated,'/home-4/whou10@jhu.edu/scratch/Wenpin/GBM/integrate_GBM_to_atlas_referenceLi/res/seurat/integrated.rds')
